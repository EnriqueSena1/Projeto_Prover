"""
Django settings for ProjetoProver project.
...
SECRET_KEY = 'django-insecure-@%i9wmzw-7*8qnty=dlu98_5w@6kn36(35o_rjv6y6_zs+owd+'
...
# Quando você estiver em desenvolvimento, use isso para que os arquivos estáticos sejam servidos
STATICFILES_DIRS = [
    BASE_DIR / "api/static",  # Caminho para o diretório 'static' dentro do seu aplicativo
]
